...
The first product slice began as the [P0 Windows Lighting Assistant](docs/prototypes/P0_LIGHTING_ASSISTANT.md) and is now an agent inside the general [P1 Osun Shell](docs/prototypes/P1_OSUN_SHELL.md). Osun runs Qwen locally on the Agent Box, brings up focused widgets when agents are called, and preserves exact owner review before real-world actions.
